 ...
 <jsp:include page="header/nativeheader.jsp"></jsp:include>
	...
	<div class="container">		
		<div class="row">
          ...
          <form action="payment2.jsp" class="review" method="post">
      ...
      <div class="col-md-8 col-lg-8">
		...
		ResultSet rs1;
		String sql1="SELECT * FROM tbl_hoteldetails INNER JOIN tbl_hotelregister where tbl_hotelregister.logid=tbl_hoteldetails.hotelid and tbl_hoteldetails.hotelid='"+hotelid+"'";
