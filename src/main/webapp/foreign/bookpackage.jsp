 ...
 <jsp:include page="header/foreignheader.jsp"></jsp:include>
	...
	<div class="container">		
	  ...
	  <div class="new-pro-container">
    	...
    	<form action="bookpackageprocess.jsp" class="menu-profile" method="post">
              ...
              <input type="hidden" name="lid" value="<%=id%>">
                ...
                <font color="black" size="2px"><b>
                 ...
                 <label><b>Number of Travelers</b></label>
                     <input type="text" class="form-control" placeholder="Number of travelers(age 12+)" name="num" required>
                                        </div>
