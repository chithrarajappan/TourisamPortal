...
<script>window.print();</script>
	...
	<div id="page-wrap">
<%
String sql1="SELECT * FROM tbl_homestaydetails INNER JOIN tbl_hotelregister where tbl_hotelregister.logid=tbl_homestaydetails.hotelid and tbl_homestaydetails.hotelid='"+toid+"'";
...
Phone: <%=rs1.getString("contact_number") %></textarea>
		...
		<div id="customer">
<%
String sql="SELECT * FROM tbl_foreignerregister where logid='"+fromid+"'";
