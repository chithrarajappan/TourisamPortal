   ...
   <%
	...
	String pid=request.getParameter("pid");   
				...
				if(bln > amt)
						{
							...
							PreparedStatement ps1=con.prepareStatement("INSERT INTO `tbl_transaction1`(`fromid`,`fromaccount`,`toid`,`toaccount`,`amount`,`bookingdate`,`bookingid`) VALUES (?,?,?,?,?,?,?)");
							ps1.setString(1,id);
						    ...
						    out.println("<script type=\"text/javascript\">");
							   ...
							   out.println("window.open('viewbill3.jsp','_blank')");
		...
		if (request.getParameter("cancel")!=null)
		{
			...
			String sql1="delete from tbl_packagebook where id='"+bid+"'";
