          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">	
          			<div class="single-slider owl-carousel">
          				<div class="item">
          				<h2><i><%=rs.getString("hotelname")%></i>&nbsp;&nbsp;Hotel<a href="Login/login.jsp"><button style="float:right"; type="button" class="btn btn-warning py-2 px-7"><i>Book Now</i></button></a></h2>
          		...
          		<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
    				...
    				<p><%=rs.getString("about") %></p>
    					...
    					<li><h2>Features</h2></li>
    					   ...
    					   <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 <% out.println("car parking is available at hotel premises");%>
    					   </li> 
			                <% if(gym.equals("yes")) %>
			                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 <% out.println("Gymnastics and Health club facilites are available");%>
    						 </li> 
    						 <% if(wifi.equals("yes")) %>
			                 <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 <% out.println("WiFi availability at hotel premises");%>
    						 </li>
    						 <% if(restaurent.equals("yes")) %>
			                 <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 <% out.println("Restaurent is available 24x7 inside hotel");%>
    						 </li>
    						 ...
    						 <% if(bar.equals("yes")) %>
			                 <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 <% out.println("Attaced Bar facilities");%>
    						 </li>
    						 <% if(ac.equals("yes")) %>
			                 <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 <% out.println("Air conditioned Rooms");%>
    						 </li>
    						 <% if(spa.equals("yes")) %>
			                 <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 <% out.println("Spa and massage parlour");%>
    						 </li>
    						 <% if(pool.equals("yes")) %>
			                 <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 <% out.println("Pool");%>
			                 ...
			                 <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 <% out.println("Playground inside the Hotel premises");%>
    						 </li>
    						 <% if(conference.equals("yes")) %>
			                 <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 <% out.println("Conference hall is available inside hotel");%>
    						 </li>
    						 <% if(wheelchair.equals("yes")) %>
			                 <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 <% out.println("Wheelchair accesibility is available");%>
    						 </li>
		                    </ul>
		                    <ul class="ml-md-5">
		                   ...
		                   <li><b>Family Room &nbsp; :&nbsp; </b><i class="fa fa-rupee" style="font-size:24px">&nbsp;<%=rs.getString("family") %></i></li>
		                   <li><b>Dormitory &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  :&nbsp; </b><i class="fa fa-rupee" style="font-size:24px">&nbsp;<%=rs.getString("dormitory") %></i></li>
		                    </ul>
		                    </div>
		       
		                    <h2>Fixed Service Charges &nbsp;&nbsp;</h2><i class="fa fa-rupee" style="font-size:24px"> <%=rs.getString("amountcharges") %></i> &nbsp; per Room
		                    	 	<br/><br/>
