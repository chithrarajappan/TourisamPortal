          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          				<h2><i><%=rs.getString("hotelname")%></i>&nbsp;&nbsp;Homestay<a href="Login/login.jsp"><button style="float:right"; type="button" class="btn btn-warning py-2 px-7"><i>Book Now</i></button></a></h2>
