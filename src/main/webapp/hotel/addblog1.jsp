        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" action="addingblogprocess1.jsp" method="post" enctype="multipart/form-data">
                ...
                <label><b>Today Date</b></label>
                 ...
                 <input type="hidden" name="bloger" value="Hotel" class="form-control form-control-user"  required="">
