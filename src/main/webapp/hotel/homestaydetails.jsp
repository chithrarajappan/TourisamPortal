        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" action="homestayupdateprocess.jsp" method="post" enctype="multipart/form-data">
               ...
               <div class="col-md-6"> <label><b>Do you provide WIFI facilities to your customers?</b></label></div>
                ...
                <input type="text" class="form-control form-control-user" name="single" required="">
                
                </div>
                
                <div class="form-group row">
                <label><b>Rent for Double rooms</b></label>
                <input tyrpe="text" class="form-control form-control-user" name="doubl" required="">
                </div>
                ...
                <input type="submit" class="btn btn-success btn-user btn-block" name="homestay" value="Submit">  
                <hr>
              </form>
