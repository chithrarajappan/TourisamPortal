        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" action="addingplaceprocess.jsp" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                 <label><b>Place</b></label>
                    <input type="text" class="form-control form-control-user" name="placename" placeholder="place Name" required="">
                   </div>
