...
<!--===============================================================================================-->
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar" style="background-color: black;">
	    <div class="container">
	      <a class="navbar-brand" href="./index.jsp">Traveller.com</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item submenu dropdown">
                 <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Client</a>
         	     <ul class="dropdown-menu" style="background-color:#000;">
			     <li class="nav-item">
			     <a class="nav-link" style="color:#fff;" href="agencyregistration.jsp">Agency</a></li>
			     <li class="nav-item">
			     <a class="nav-link" style="color:#fff;" href="hotelregistration.jsp">Hotels</a></li>
			     </ul>
         	  </li> 
	          <li><button type="button" class="nav-item btn btn-success" data-toggle="modal" data-target="#exampleModal">Sign in</button></li>
