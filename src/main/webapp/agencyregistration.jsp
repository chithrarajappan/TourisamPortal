            ...
            <div class="p-5">
              ...
              <form class="user" action="MailApp" method="post">
                ...
                <label><b>Agency Registration Id</b> </label>
                    <input type="text" class="form-control form-control-user" name="message" placeholder="Id For Agency">
                  </div>     
                <input type="submit" class="btn btn-success btn-user btn-block" name="agency" value="Submit">  
                <hr>
              </form>
            </div>
          </div>
